# Historical Proof Run: usefulness_ablation
Generated: 2026-03-13 21:07 UTC

## Run Configuration
- **Mode**: usefulness_run
- **Backfill window**: 2024-01-01 to 2025-01-01
- **Eval window**: 2024-03-01 to 2025-01-01
- **Cadence**: 7 days
...
|--------|-------|--------|---------|---------|
| exit | 1 | +4.49% | +1.88% | +20.69% |
| hold | 203 | +0.58% | +2.65% | +5.65% |
| initiate | 15 | +2.39% | +1.51% | +14.19% |

## Conviction Bucket Analysis
| Bucket | Actions | Avg Conviction | Avg 5D | Avg 20D | Avg 60D |
|--------|---------|----------------|--------|---------|---------|
| low | 203 | 0 | +0.58% | +2.65% | +5.65% |
| medium | 14 | 52 | +1.91% | +2.00% | +15.10% |
| high | 2 | 80 | +6.79% | -1.71% | +11.12% |
...
| 2025-09-11 | GOOGL | exit | 95.0 | +4.49% | +1.88% | +20.69% |
| 2025-09-04 | CRM | initiate | 60.1 | +3.30% | +0.95% | +7.29% |
| 2025-10-02 | MSFT | initiate | 50.0 | +1.60% | +0.93% | -5.45% |
| 2025-08-28 | CRWD | initiate | 53.5 | -6.45% | +0.79% | +19.84% |
| 2025-08-14 | INTC | initiate | 50.0 | +6.08% | +0.59% | +55.99% |

## Worst Decisions (by 20D forward return)
| Date | Ticker | Action | Conviction | 5D | 20D | 60D |
|------|--------|--------|------------|-----|------|------|
| 2025-10-30 | META | initiate | 60.6 | -5.87% | -11.43% | -1.09% |
| 2025-08-28 | AMD | initiate | 50.0 | -3.71% | -5.59% | +54.03% |
| 2025-08-28 | NVDA | initiate | 50.0 | -5.21% | -5.48% | +6.29% |
| 2025-11-06 | PLTR | initiate | 65.0 | +9.09% | -5.30% | +1.54% |
| 2025-10-30 | AAPL | initiate | 53.1 | -0.50% | -0.95% | +0.97% |
...
|--------|---------|------|--------|--------|---------|---------|-----------|
| AAPL | 10 | 3 | 6 | +0.45% | +0.59% | +0.92% | 91% |
| AMD | 19 | 6 | 20 | +1.28% | +7.92% | +21.45% | 91% |
| AMZN | 10 | 3 | 8 | +1.63% | -0.43% | -0.45% | 91% |
| AVGO | 18 | 7 | 28 | +0.42% | +1.47% | +4.65% | 91% |
| CRM | 18 | 6 | 16 | +0.83% | +1.66% | +2.22% | 91% |
| CRWD | 19 | 5 | 18 | +0.16% | +1.89% | +6.14% | 91% |
| GOOGL | 2 | 5 | 16 | +3.87% | +4.18% | +21.47% | 91% |
| INTC | 21 | 13 | 21 | +1.08% | +7.35% | +24.13% | 91% |
| META | 10 | 5 | 14 | +0.38% | +1.57% | +2.82% | 91% |
| MSFT | 14 | 4 | 10 | +0.42% | -1.17% | -5.78% | 91% |
| NOW | 14 | 6 | 11 | -0.41% | -4.12% | -12.64% | 91% |
| NVDA | 19 | 4 | 8 | +0.26% | +0.93% | +2.65% | 91% |
| PLTR | 9 | 2 | 6 | +1.78% | +4.75% | +1.54% | 91% |
| QCOM | 19 | 6 | 14 | -0.02% | +2.26% | +4.50% | 91% |
| TSLA | 17 | 5 | 14 | +2.06% | +5.19% | +4.68% | 91% |
...
- Change rate: 0.696 per review
- Short-hold exits (<30d): 1
...
## Memory Ablation: ON vs OFF
### Regeneration Differences
| Metric | Memory ON | Memory OFF |
|--------|-----------|------------|
| Thesis updates | 75 | 77 |
| State changes | 29 | 28 |
| State flips | 9 | 8 |

### Portfolio Differences
| Metric | Memory ON | Memory OFF | Delta |
|--------|-----------|------------|-------|
| Return | +3.16% | +3.23% | -0.07% |
| Drawdown | 4.99% | 4.99% | — |
| Initiations | 15 | 15 | — |
| Exits | 1 | 1 | — |
...
| memory_comparison.csv | Memory ON vs OFF comparison |

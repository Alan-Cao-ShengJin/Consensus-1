...
Generated: 2026-03-15 01:05 UTC
...
|--------|-------|--------|---------|---------|
| exit | 6 | +4.98% | +13.44% | +22.29% |
| hold | 193 | +0.67% | +3.33% | +10.16% |
| initiate | 17 | -3.03% | +1.38% | +7.06% |
...
| 2024-08-07 | CRM | initiate | 50.0 | +4.70% | +10.07% | +20.06% |
| 2024-08-28 | INTC | trim | 50.0 | +12.39% | +9.48% | +15.66% |
...
| 2024-09-25 | QCOM | initiate | 50.0 | +1.06% | +3.46% | -6.82% |
...
| GOOGL | 22 | 11 | 11 | +0.39% | +2.74% | +7.54% | 97% |
| INTC | 10 | 10 | 11 | -0.87% | +2.33% | +13.44% | 97% |
| META | 22 | 6 | 6 | +0.47% | +2.83% | +7.25% | 97% |
...
## Decision Summary
- Total actions: 343
- Recommendation changes: 36
- Change rate: 1.565 per review
...
- initiate actions have negative avg 5D return (-3.03%)
...
| Avg forward 20D after exit | +13.44% |

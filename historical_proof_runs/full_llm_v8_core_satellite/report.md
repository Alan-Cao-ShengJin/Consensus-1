# Historical Proof Run: full_llm_v8_core_satellite
Generated: 2026-03-14 18:45 UTC
...
|--------|-------|--------|---------|---------|
| add | 11 | +1.17% | -0.14% | +1.22% |
| exit | 1 | +10.95% | +9.54% | N/A |
| hold | 82 | +0.19% | +0.85% | +0.51% |
...
| 2026-01-15 | AMD | add | 95.1 | +1.76% | -12.17% | — |
...
- AMD had 2 initiate/add actions followed by >5% loss at 20D
